...
const LEVELS = {
  ...
  3: {
    title: 'Level 3 – PC zusammenbauen',
    questions: [
      {
        type: 'quiz',
        part: 'mainboard',
        text: 'Was installierst du ZUERST beim PC-Bauen?',
        answers: [
          'Grafikkarte ins Gehäuse',
          'CPU auf das Mainboard',
          'SSD an das Netzteil',
          'RAM ins Gehäuse'
        ],
        correct: 1,
        explanation: 'Zuerst wird die CPU auf dem Mainboard installiert – noch BEVOR das Mainboard ins Gehäuse kommt. So hat man mehr Platz zum Arbeiten.'
      },
      {
        type: 'quiz',
        part: 'cooler',
        text: 'Wann wird der CPU-Kühler installiert?',
        answers: [
          'Ganz am Anfang, vor der CPU',
          'Direkt nach der CPU, vor dem RAM',
          'Nach der GPU',
          'Als letztes nach dem Einbau im Gehäuse'
        ],
        correct: 1,
        explanation: 'Nach der CPU kommt direkt der Kühler – mit Wärmeleitpaste! Danach folgen RAM, Mainboard-Einbau ins Gehäuse, GPU und schließlich das Netzteil.'
      },
      {
        type: 'order',
        text: 'Bringe die Schritte in die richtige Reihenfolge!',
        steps: [
          { id: 'cpu',    label: '🧠 CPU einbauen',            correct: 0 },
          { id: 'cooler', label: '❄️ CPU-Kühler montieren',    correct: 1 },
          { id: 'ram',    label: '💾 RAM einsetzen',           correct: 2 },
          { id: 'mb',     label: '🟢 Mainboard ins Gehäuse',   correct: 3 },
          { id: 'psu',    label: '⚡ Netzteil einbauen',       correct: 4 },
          { id: 'gpu',    label: '🎮 GPU einsetzen',           correct: 5 },
          { id: 'ssd',    label: '💿 SSD anschließen',        correct: 6 },
        ]
      },
      {
        type: 'quiz',
        part: 'case',
        text: 'Warum ist Luftzirkulation im Gehäuse wichtig?',
        answers: [
          'Für schönere Optik',
          'Damit der PC schneller wird',
          'Um alle Komponenten zu kühlen und Überhitzung zu vermeiden',
          'Damit der PC leiser wird'
        ],
        correct: 2,
        explanation: 'Gute Luftzirkulation ist essentiell! Warme Luft muss raus, kühle rein. Ohne ausreichende Kühlung überhitzen Komponenten und können Schaden nehmen.'
      },
      {
        type: 'quiz',
        part: 'ssd',
        text: 'Was installiert man nach dem PC-Zusammenbau als erstes?',
        answers: [
          'Ein Antivirenprogramm',
          'Das Betriebssystem (z.B. Windows)',
          'Die Grafiktreiber',
          'Steam'
        ],
        correct: 1,
        explanation: 'Nach dem Zusammenbau muss zuerst das Betriebssystem (OS) installiert werden – z.B. Windows 11 oder Linux. Danach kommen Treiber und Programme.'
      }
    ]
  }
};
